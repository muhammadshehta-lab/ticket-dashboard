"""
dashboard.py — In-Store Requests Dashboard (Stable Daily Trend Edition)
"""
    ...
    try:
        ...
        for worksheet in spreadsheet.worksheets():
            ...
            if len(data) > 1:
                ...
                # خريطة ذكية لربط الأعمدة المتغيرة ومقاومة اختلاف الحروف والمسافات
                mapped_cols = {}
...
with tab1:
    ...
    # حساب المتوسطات الزمنية التفاعلية (على مستوى الإجراء الواحد بالدقائق لمنع الأرقام الفلكية التراكمية)
