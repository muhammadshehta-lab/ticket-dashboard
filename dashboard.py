...
# ══════════════════════════════════════════════════════════════════════════════════
#  CSS  — HIGH-VISIBILITY BOLD & LARGE TYPOGRAPHY PUFF COLOR THEME BLOCK
# ══════════════════════════════════════════════════════════════════════════════════
st.markdown("""
<style>
...
THEME = dict(
    ...
    plot_bgcolor="rgba(247,241,225,0.6)", # Blended neatly with Puff palette values
    font_color="#0f172a",                 # Deep contrast typography color matching text rules
