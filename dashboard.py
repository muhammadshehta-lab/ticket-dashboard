"""
dashboard.py — In-Store Requests Dashboard (Strict Unique Column Mapping Build)
"""
...
# ── جلب البيانات والربط الديناميكي الآمن للأعمدة (يمنع التكرار تماماً) ───────────
    ...
    try:
        ...
        for worksheet in spreadsheet.worksheets():
            ...
            if len(data) > 1:
                ...
                # ربط الأعمدة بطريقة صارمة تمنع تعيين نفس الاسم لعمودين (تجنب الـ Reindexing Error)
                mapped_cols = {}
...
with tab1:
    ...
    # حساب المتوسطات الزمنية التفاعلية بالدقائق
    ...
    # ── [A] الصف العلوي: الـ 8 فلاش كاردز المجمعة للأوقات (FRT, AHT, TAT) جنب بعض بالظبط
    ...
    r1_c3.markdown(kpi("Closed with Issue", f"{comp_with_issue:,}",
