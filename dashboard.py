...
with tab1:
    ...
    # كروت الـ KPI الرئيسية في القمة
    ...
    # الـ SLA Time Tiers مباشرة تحت فلاش كاردز
    ...
    # كيرف الـ Rush Hours المزدوج مع منحنى الـ Response Time
    ...
    # جدول الـ Request Breakdown بالتفصيل في الأسفل
