    ...
    if is_admin():
        ...
        with c_exp2:
            ...
            ppt_file_data, err_msg = generate_pptx_summary(
                d_from.strftime('%Y-%m-%d'), d_to.strftime('%Y-%m-%d'), int(total), curr_avg_per_day, ok, ok_pct, issue, issue_pct,
